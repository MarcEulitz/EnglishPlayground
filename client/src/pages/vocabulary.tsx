...
const VocabularyPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      ...
      const preparedQuestions = await Promise.all(selectedVocab.map(async (vocab: any, index: number) => {
  ...
  // ...weitere Funktionen wie handleOptionClick, handleCheckAnswer, saveProgress usw. bleiben gleich.
  ...
  return (
    <div className="min-h-screen">
      ...
      {showFeedback && (
        <CharacterFeedback type={feedbackType} />
      )}
