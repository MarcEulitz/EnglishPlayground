...
const characterPhrases = {
  mia: {
    ...
    greeting: {
      happy: ['Hallo! Ich bin Mia!', 'Willkommen zurück!', 'Schön, dass du da bist!'],
  ...
  buddy: {
    ...
    greeting: {
      happy: ['Hi there! I\'m Buddy!', 'Ready to learn?', 'Let\'s learn English together!'],
  ...
  teacher: {
    ...
    greeting: {
      happy: ['Welcome to class!', 'Let\'s start our lesson!', 'Ready to learn English?'],
...
const characterVoices = {
  mia: { lang: 'de-DE', pitch: 1.2, rate: 1, 
         voiceName: 'Google Deutsch' },
  buddy: { lang: 'en-US', pitch: 1.1, rate: 1.1, 
           voiceName: 'Google US English' },
  teacher: { lang: 'en-GB', pitch: 0.9, rate: 0.9, 
...
const useAudio = () => {
  ...
  const playCharacterPhrase = useCallback((
    ...
    const characterSet = characterPhrases[character] || characterPhrases.default;
    const scenarioSet = characterSet[scenario] || {};
    const phrases = scenarioSet[emotion] || 
                   scenarioSet.neutral || 
                   characterPhrases.default[scenario].neutral;
