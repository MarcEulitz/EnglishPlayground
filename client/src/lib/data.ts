...
export function generateTopicData(topic: string): VocabularyItem[] {
  ...
  // Thema: Family/Familie
    ...
    genericVocab = [
      { word: "mother", translation: "Mutter", imageUrl: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 200 120'%3E%3Crect fill='%23f0f0f0' width='200' height='120'/%3E%3Ccircle fill='%23fdbcb4' cx='100' cy='45' r='20'/%3E%3Cpath fill='%23d2691e' d='M80 25 Q100 15 120 25 Q120 35 100 40 Q80 35 80 25'/%3E%3Cpath fill='%23ff69b4' d='M70 65 Q100 50 130 65 Q130 95 100 105 Q70 95 70 65'/%3E%3Ctext x='100' y='110' text-anchor='middle' font-size='12' fill='%23333'%3EMother%3C/text%3E%3C/svg%3E" },
      { word: "father", translation: "Vater", imageUrl: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 200 120'%3E%3Crect fill='%23f0f0f0' width='200' height='120'/%3E%3Ccircle fill='%23fdbcb4' cx='100' cy='45' r='20'/%3E%3Cpath fill='%23654321' d='M80 25 Q100 15 120 25 Q120 35 100 40 Q80 35 80 25'/%3E%3Cpath fill='%234169e1' d='M70 65 Q100 50 130 65 Q130 95 100 105 Q70 95 70 65'/%3E%3Ctext x='100' y='110' text-anchor='middle' font-size='12' fill='%23333'%3EFather%3C/text%3E%3C/svg%3E" },
      { word: "brother", translation: "Bruder", imageUrl: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 200 120'%3E%3Crect fill='%23f0f0f0' width='200' height='120'/%3E%3Ccircle fill='%23fdbcb4' cx='100' cy='50' r='18'/%3E%3Cpath fill='%23daa520' d='M82 32 Q100 22 118 32 Q118 42 100 47 Q82 42 82 32'/%3E%3Cpath fill='%23228b22' d='M75 68 Q100 55 125 68 Q125 95 100 105 Q75 95 75 68'/%3E%3Ctext x='100' y='115' text-anchor='middle' font-size='12' fill='%23333'%3EBrother%3C/text%3E%3C/svg%3E" },
      { word: "sister", translation: "Schwester", imageUrl: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 200 120'%3E%3Crect fill='%23f0f0f0' width='200' height='120'/%3E%3Ccircle fill='%23fdbcb4' cx='100' cy='50' r='18'/%3E%3Cpath fill='%23ff1493' d='M82 32 Q100 22 118 32 Q118 42 100 47 Q82 42 82 32'/%3E%3Cpath fill='%23da70d6' d='M75 68 Q100 55 125 68 Q125 95 100 105 Q75 95 75 68'/%3E%3Ctext x='100' y='115' text-anchor='middle' font-size='12' fill='%23333'%3ESister%3C/text%3E%3C/svg%3E" },
      { word: "baby", translation: "Baby", imageUrl: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 200 120'%3E%3Crect fill='%23f0f0f0' width='200' height='120'/%3E%3Ccircle fill='%23fdbcb4' cx='100' cy='55' r='15'/%3E%3Cpath fill='%23ffd700' d='M85 40 Q100 30 115 40 Q115 50 100 55 Q85 50 85 40'/%3E%3Cpath fill='%23ffb6c1' d='M80 70 Q100 60 120 70 Q120 90 100 95 Q80 90 80 70'/%3E%3Ctext x='100' y='110' text-anchor='middle' font-size='12' fill='%23333'%3EBaby%3C/text%3E%3C/svg%3E" }
    ];
  }
